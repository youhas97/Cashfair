...
function GroupCreationStoreProvider( { children } ) {
...
function useGroupCreationStore() {
  const context = useContext(groupData)
  if (context === undefined)
    throw new Error("useGroupCreationStore must be used within a GroupStoreProvider")

    return context
}

export { useGroupCreationStore, GroupCreationStoreProvider }